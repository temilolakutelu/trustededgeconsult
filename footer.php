            ...
            <div class="row">
                <div class="col-md-3 col-xs-6">
                    <aside class="f_widget about_widget">
                        <img src="img/tec-logo-small.png" alt="">
                        <p>We are a solutions and technology company, and we apply unbeatable and unique approaches to
    ...
    <div class="footer_copyright">
        <div class="container-fluid">
            <div class="footer_copyright_inner">
                <div class="pull-left">
                    <p>Copyright © Trusted Edge Consult
                ...
                <div class="pull-right">
                    <ul class="f_social">
                        ...
                        <li><a href="skype:123456789?call" target="_blank"><i class="fa fa-skype"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
