		...
		<div class="col-md-12">
			<div class="panel panel-default list-panel">
				<div class="panel-heading">
					<h2>All Gallery Categories </h2>
					<div class="panel-ctrls">
            <div class="pull-left list-button" >
              <?php echo anchor(site_url('gallery_category/create'), 'Add', array('class' => 'btn btn-primary')); ?>
            </div>
        ...
        <div class="panel-body no-padding">
              ...
              <?php
                ...
                foreach($category_data as $cat){
                  ...
                  <td>'.$cat->name.'</td>
                <td><img src='.base_url().'images/thumbnail/'.$cat->image.' width="100px"></td>
          								<td>
                             '.anchor(site_url('gallery_category/update/'.$cat->id), 'Edit', array('class' => 'btn btn-primary btn-sm')).'
                             '.anchor(site_url('gallery_category/delete/'.$cat->id), 'Delete', array('class' => 'btn btn-danger btn-sm')).'
                          </td>
          						</tr>';
                };
                ?>
