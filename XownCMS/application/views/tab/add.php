...
<div class="panel panel-default form-panel" data-widget='{"draggable": "false"}'>
    ...
    <div class="panel-body">
       <form action="<?= site_url('tab/create_action'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group col-md-5">
               
                <label for="cus_id">Tab Title<span class="required">*</span></label>
            ...
            <div class="form-group col-md-5">
                ...
                <label for="cus_id">Tab Title Summary <span class="required">*</span></label>
                <input type="text" class="form-control" name="brief" value="<?php echo set_value('brief'); ?>" pattern="[a-zA-Z0-9\s]+" title="Only Alphanemeric allowed" maxlength="35" />
                
            </div>
            
             
            <div class="form-group col-md-5">
                <label for="staff_no">Web reference <span class="required">* </span></label>
                <input type="text" class="form-control" name="reference" placeholder="Web reference" value="<?php echo set_value('reference'); ?>"/>
            </div>
            
             <div class="form-group col-md-5">
                <label for="image" class="control-label">Tab Image (Width:450px by 300px)</label>
          ...
          <div class="form-group col-md-10">
                <label for="staff_no">Tab description/summary<span class="required">*</span></label>
                <textarea class="form-control autosize" rows="3" name="description" id="summernote1"><?php echo set_value('description'); ?></textarea>
            </div>
