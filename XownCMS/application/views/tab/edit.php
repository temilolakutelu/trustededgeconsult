...
<div class="panel panel-default form-panel" data-widget='{"draggable": "false"}'>
    ...
    <div class="panel-body">
       <form action="<?= site_url('tab/edit_action'); ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group col-md-10">
                ...
                <textarea class="form-control autosize" rows="3" name="description" id="summernote1"><?php echo $description; ?></textarea>
            </div>
