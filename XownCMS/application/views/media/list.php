	...
	<div class="row">
		<div class="col-md-12">
            ...
            <div class="pull-left list-button" >
              <?php echo anchor(site_url('multimedia/create'), 'Add', array('class' => 'btn btn-primary')); ?>
            </div>
        ...
        <div class="panel-body no-padding">
              ...
              <?php
                ...
                foreach($tab_data as $news){?>
                    ...
                    <tr class="odd gradeX">
          								<td class="hidden"></td>
                                        <td><?= $news->mediaTitle; ?></td>
                                         <td><?= $news->mediaURL; ?></td>
                                          <td><?= $news->mediaDate; ?></td>
                                        <td style="width:15%"><?= anchor(site_url('multimedia/edit/'.$news->mediaID), 'Edit', array('class' => 'btn btn-primary btn-sm')).' '.anchor(site_url('multimedia/delete/'.$news->mediaID), 'Delete', array('class' => 'btn btn-danger btn-sm')) ?>
                          </td>
                    </tr>
             <?php  }  ?>
              </tbody>
