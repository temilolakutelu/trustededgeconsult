...
<div class="panel panel-default form-panel" data-widget='{"draggable": "false"}'>
    ...
    <div class="panel-body">
       <form action="<?= site_url('blog/create_action'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-5"> 
                ...
                <input type="text" class="form-control" name="author" value="<?php echo set_value('author'); ?>"  title="Only Alphanumeric allowed" />
            </div>
            <div class="form-group col-md-5"> 
                <label for="tag">TagLine<span class="required">*</span></label>
                <input type="text" class="form-control" name="tag" value="<?php echo set_value('tag'); ?>"  title="Only Alphanumeric allowed" />
            </div>
            <div class="form-group col-md-5"> 
                <label for="subtitle">SubTitle<span class="required">*</span></label>
                <textarea type="text" class="form-control" name="subtitle" value="<?php echo set_value('subtitle'); ?>"  title="Only Alphanumeric allowed"  cols="15" rows="5"></textarea>
          ...
          <label for="image" class="control-label">Featured Image <span class="required">*(Width:1024px by 600px)</span></label>
            ...
            <div class="form-group col-md-10">
                ...
                <textarea class="form-control autosize" rows="3" name="article" id="summernote"><?php echo set_value('article'); ?></textarea>
            </div>
