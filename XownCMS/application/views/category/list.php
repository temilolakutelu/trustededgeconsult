		...
		<div class="col-md-12">
			<div class="panel panel-default list-panel">
				<div class="panel-heading">
					<h2>All Page Categories </h2>
					<div class="panel-ctrls">
            <div class="pull-left list-button" >
              <?php echo anchor(site_url('category/create'), 'Add', array('class' => 'btn btn-primary')); ?>
            </div>
              ...
              <?php
                ...
                foreach($category_data as $cat){
                  echo '<tr class="odd gradeX">
          								<td>'.$cat->name.'</td>
          								<td>
                             '.anchor(site_url('category/update/'.$cat->id), 'Edit', array('class' => 'btn btn-primary btn-sm')).'
                             '.anchor(site_url('category/delete/'.$cat->id), 'Delete', array('class' => 'btn btn-danger btn-sm')).'
                          </td>
          						</tr>';
                };
                ?>
