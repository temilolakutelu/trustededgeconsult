...
<div class="panel panel-default form-panel" data-widget='{"draggable": "false"}'>
    ...
    <div class="panel-body">
       <form action="<?= site_url('staff_profile/edit_action'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group col-md-5">
               
                <label for="cus_id">Title<span class="required">*</span></label>
                <input type="text" class="form-control" name="title" value="<?php echo $title; ?>"/>
                <input type="hidden" value="<?= $id; ?>" name="id">
                 <input type="hidden" value="<?= $image; ?>" name="img_id">
                  <input type="hidden" value="<?= $pdf; ?>" name="cv_id">
            </div>
            
            <div class="form-group col-md-5">
               
                <label for="cus_id">Fullname<span class="required">*</span></label>
                <input type="text" class="form-control" name="name" value="<?php echo $name; ?>" placeholde="Full name"/>
            ...
            <div class="form-group col-md-5">
                ...
                <select type="text" class="region_id form-control" name="dept" id="dept" required>
                    ...
                    <?php
                        foreach ($dept as $region) {?>
                            <option value="<?= $region->id?>" <?php if($region->id == $dept_id){ echo 'selected';}?>><?= $region->college?></option>
                    <?php    }
                    ?>
                </select>
            </div>
             ...
             <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" name="email" id="staff_no" placeholder="Email" value="<?php echo $email; ?>" maxlength="120"/>
            </div>
            
            <div class="form-group col-md-5">
                <label for="staff_no">Facebook Page</label>
                <input type="text" class="form-control" name="fbook" id="fbook" placeholder="Facebook page" value="<?php echo $fbook; ?>" maxlength="120"/>
            </div>
            
            <div class="form-group col-md-5">
                <label for="staff_no">Linkedin Page</label>
                <input type="text" class="form-control" name="link" id="staff_no" placeholder="Linkedin Page" value="<?php echo $link; ?>" maxlength="120"/>
            </div>
            
            <div class="form-group col-md-5">
                <label for="staff_no">Google-plus Page</label>
                <input type="text" class="form-control" name="gplus" id="staff_no" placeholder="Google-plus Page" value="<?php echo $gplus; ?>" maxlength="120"/>
            </div>
            ...
            <div class="form-group col-md-5">
                ...
                <div class="fileinput fileinput-new" style="width: 100%;" data-provides="fileinput">
                    ...
                    <div>
                        <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>
                        <span class="btn btn-default btn-file"><span class="fileinput-new">Select PDF File</span><span class="fileinput-exists">Change</span><input type="file" id="image" name="pdf"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group col-md-10">
                ...
                <textarea class="form-control autosize" rows="3" name="biography" id="summernote1"><?php echo $biography; ?></textarea>
            </div>
            
             <div class="form-group col-md-10">
                <label for="health_history">Publications </label>
                <textarea class="form-control autosize" rows="3" name="public" id="summernote2"><?php echo $public; ?></textarea>
            </div>
            
            <div class="form-group col-md-10">
                <label for="health_history">Research </label>
                <textarea class="form-control autosize" rows="3" name="research" id="summernote3"><?php echo $research; ?></textarea>
            </div>
            
            <div class="form-group col-md-10">
                <label for="health_history">Conference </label>
                <textarea class="form-control autosize" rows="3" name="conference" id="summernote4"><?php echo $conference; ?></textarea>
            </div>
            
            <div class="form-group col-md-10">
                <label for="health_history">Courses </label>
                <textarea class="form-control autosize" rows="3" name="course" id="summernote5"><?php echo $course; ?></textarea>
            </div>
            
            <div class="form-group col-md-10">
                <label for="health_history">Profesional Qualifications </label>
                <textarea class="form-control autosize" rows="3" name="qualification" id="summernote6"><?php echo $qualification; ?></textarea>
            </div>
