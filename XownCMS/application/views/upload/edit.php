...
<div class="panel panel-default form-panel" data-widget='{"draggable": "false"}'>
    ...
    <div class="panel-body">
        <form action="<?= site_url('upload/edit_action') ?>" method="post" enctype="multipart/form-data">            
            <div class="form-group col-sm-5">
            <label for="name">File name<span class="required"> *</span></label>
                <input type="text" class="form-control" name="name" id="name" value="<?= $Upload_details->filename; ?>" />
            </div>
            ...
            <input type="hidden" name="id" value="<?php echo $Upload_details->doc_id; ?>" />
            <div class="col-sm-12">
