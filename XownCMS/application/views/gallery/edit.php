    ...
    <div class="panel-body">
        <form action="<?= site_url('photos/edit_action') ?>" method="post" enctype="multipart/form-data">            
            <div class="form-group col-sm-5">
                <label for="name">Image title/Description<span class="required"> *</span></label>
                <input type="text" class="form-control" name="title" id="name" value="<?= $gallery_details->gal_title; ?>" />
            </div>
            ...
            <div class="form-group col-md-10">
                <label for="image" class="control-label">Image <span class="required">*(Width:1090px by 750px)</span></label>
            ...
            <input type="hidden" name="id" value="<?php echo $gallery_details->gallery_id; ?>" />
            <div class="col-sm-12">
                <button type="submit" class="btn btn-primary">Update Photo gallery</button> 
                <a href="<?php echo site_url('photos') ?>" class="btn btn-default">Cancel</a>
            </div>
        </form>
    </div>
</div>
