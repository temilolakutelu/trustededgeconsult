...
<div class="panel panel-default form-panel" data-widget='{"draggable": "false"}'>
    ...
    <div class="panel-body">
       <form action="<?= site_url('newspage/create_action'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-5">
             ...
             <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" name="description" id="staff_no" placeholder="Description" value="<?php echo set_value('description'); ?>" maxlength="120"/>
            </div>
