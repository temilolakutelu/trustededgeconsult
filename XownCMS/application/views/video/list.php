		...
		<div class="col-md-12">
			<div class="panel panel-default list-panel">
				<div class="panel-heading">
					<h2>All Video gallery </h2>
					<div class="panel-ctrls">
            <div class="pull-left list-button" >
              <?php echo anchor(site_url('video/create'), 'Add', array('class' => 'btn btn-primary')); ?>
            </div>
          </div>
				</div>
        <div class="panel-body no-padding">
              ...
              <?php
                            foreach($gallery_lists as $row) {?>
								...
								<td><?= $row->title; ?></td>
								<td><?= $row->url; ?></td>
								<td class="center"><img src="<?= base_url(); ?>images/thumbnail/<?= $row->thumb; ?>" style="width:100px; height:50px"></td>
								<td class="center" style="width:15%">
									<a class="btn btn-sm btn-info" href="<?= site_url('video/edit/'.$row->id); ?>">
										<i class="halflings-icon white edit"></i> Edit  
									</a>
									<a class="btn btn-sm btn-danger" href="<?= site_url('video/delete/'.$row->id); ?>">
